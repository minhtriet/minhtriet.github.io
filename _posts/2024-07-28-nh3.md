...
﻿
 <img alt="image" src="https://github.com/user-attachments/assets/57b18baa-654b-4631-bdba-e2e6137157dc">

 ﻿
</div>

The search boundary condition is of utmost important. Here I set each edge of the searching bound to be 1 unit bigger than the catalyst substrate. It increases the search space by 33\%
