...
Here is the common work flow for a computational chemistry project from [1]


<figure>
  <img width="1024" alt="image" src="https://github.com/user-attachments/assets/00af4999-f427-478d-bf28-cd2eea8dc342">
  <figcaption>Fig 1. Generic flowchart of a computational quantum computer part. Most of the </figcaption>
</figure>
...
[1] Reiher, Markus and Wiebe, Nathan and Svore, Krysta M. and Wecker, Dave and Troyer, Matthias. Elucidating reaction mechanisms on quantum computers. Proceedings of the National Academy of Sciences 2017
