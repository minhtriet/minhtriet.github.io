...
## Step 2
Note the added energy ($$0.98$$) below the arrow. It means it is an endothermic reaction and gradient descent would have to work particularly hard to escape the  that we have to add the energies to the system. See [visualization](#Step-2)
<div class="flex">
