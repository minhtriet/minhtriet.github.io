...
## Motivation
To define a affine transformation for a molecule, we need to define translation parameter $$t_x, t_y, t_z$$ and rotational parameter $$\theta_x,\theta_y,\theta_z$$. When calculating the gradientfor gradient descent, we need to know $$t_\cdot \pm \Delta_t$$ and $$\theta_\cdot \pm \Delta_\theta$$
