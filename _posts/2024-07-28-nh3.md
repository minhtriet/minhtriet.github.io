...
$$\pmb{X} \sim \mathscr{N}\begin{bmatrix}\begin{pmatrix} \mu_1 \\ \cdot \\ \mu_n\end{pmatrix},\begin{pmatrix}1 & K_{12} & \cdot & K_{1n}\\K_{21} & \ddot & 1 & \vdot & \ddot \\ & K_{n1} & \cdot & d & \ddot & K_{nn} \end{pmatrix} \end{bmatrix}$$ 
