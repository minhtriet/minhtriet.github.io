...
<div class="row">
	<div class="column">
		<figure>
	<img alt="image" width="20vw" src="https://github.com/user-attachments/assets/c981aea2-1fb2-4cad-95b8-0ba84b8cee11">
	...
	<div class="column">
		<figure>
	<img width="20vw" src="https://github.com/user-attachments/assets/aa6a75ec-c8f5-406b-82df-9de6bb4838a6">
...
In the below visualization, we color coded the atoms as follow
 ...
 $$\color{e06633}{\Rule{10mm}{5mm}{0mm}}\quad Fe \quad\quad\quad \color{3050f8}{\Rule{10mm}{5mm}{0mm}}\quad N \quad\quad\quad \color{000000}{\boxed{\color{fefefe}{\Rule{10mm}{5mm}{0mm}}} \quad H}$$
