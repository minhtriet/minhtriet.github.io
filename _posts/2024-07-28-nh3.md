...
This figure shows that most of the steps are ran in a classical computer and the quantum computer only calculate the eigenvalues of a given Hamiltonian. This post explores how variant method quantum computing can be used for the first steps with limited computer resource.
# Method
