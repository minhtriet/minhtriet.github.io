...
# Visualization
 We are going to replicate the first three steps of Figure 2, whose Hamiltonian are the most complex  in the whole pathway. In the below visualization, we color coded the atoms as 
<span class="boxed fe">
      $$Fe$$
</span>
<span class="boxed n">
