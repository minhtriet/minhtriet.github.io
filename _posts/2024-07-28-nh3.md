...
It shows that most of the steps use DFT in a classical computer and the quantum computer only calculate the eigenvalues of a given Hamiltonian. This post explores how we can use Pennylane to execute the first steps with limited computer resource. We simulate on the first three steps in Fugure 2, which are the most complex reactions. Through this, we contribute an approach to simulate chemistry reaction with (1) catalyst and (2) endothermicity.
