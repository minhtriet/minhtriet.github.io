...
BO, being a gradient-less method, does not have these requirements. After some initial samplings, we fit a Guassian around these data points. A nice point of GP is that confidence interval

<div class="row">	
	<div class="column">
 	<figure>
		<img src="https://github.com/user-attachments/assets/af199fd0-5dbe-4a2c-addb-e9fb6f2ecd2b">
  		<figcaption>Some initial random sampling</figcaption>
  	</figure>
	</div>
	<div class="column">
 	<figure>
		<img src="https://github.com/user-attachments/assets/033cceb6-5ea3-4663-af1f-b17e4708a085">
  		<figcaption>Confidence interval</figcaption>
  	</figure>
	</div>
</div>
