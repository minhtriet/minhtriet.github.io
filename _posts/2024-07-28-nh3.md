...
EI asks the question what if we draw random functions that lie inside the confident interval and sample at their minima?

![Untitled-2024-08-13-1359](https://github.com/user-attachments/assets/e2ad6247-c5ae-4dec-a4f4-fae822bd11d1)


Red and green lines are the two possible functions that satisfies the condition that they inside the 
